...
import Img1 from '@/app/assets/images/meta.webp'
import Img2 from '@/app/assets/images/ai.webp'
import Img3 from '@/app/assets/images/cloud.webp'
import Img4 from '@/app/assets/images/ambient.webp'
import Img5 from '@/app/assets/images/genomics.webp'
import Img6 from '@/app/assets/images/network.webp'
...
export const programsData: Specialization[] = [
  ...
  // Fix: Use correct path for AiImg
  {
    slug: "ai",
    header: 'Artificial Intelligence (AI) and Deep Learning Specialization',
    description:
      'The AI and Deep Learning specialization focuses on building and deploying intelligent APIs using OpenAI models and building custom Deep Learning Tensorflow models.',
    image: { src: Img2, width: 100, height: 100 }, // Fix: Use correct path for AI image
    Quarters: [
      {
        header: 'Quarter IV',
...
// next item genomics

  {
    ...
    image: { src: Img5, width: 100, height: 100 },
    Quarters: [
      {
        header: 'Quarter IV',
...
// next item network

  {
    ...
    image: { src: Img6, width: 100, height: 100 },
    Quarters: [
      {
        header: 'Quarter IV',
            ...
            {programsData.map((item, i) => (
              <div key={item.slug} onClick={() => setSelectedItems(item.slug)} className="flex gap-x-3 gap-y-2 mb-3 items-center cursor-pointer">
                <div className="flex-shrink-0 h-24 w-36 hover:w-36 hover:scale-90">
                  <Image src={item.image.src} alt={item.header} width={item.image.width} height={item.image.height} className={'h-20 object-cover rounded-md'} />
                </div>
                <div>
